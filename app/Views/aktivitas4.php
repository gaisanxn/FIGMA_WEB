...
.article-image {
    ...
    filter: brightness(70%); /* Mengurangi kecerahan gambar untuk memberi efek gelap */
}
...
<div class="article-content">
    <img src="/upload/aktivitas4.jpg" alt="TechSmart Image" class="article-image">
    <h2 class="article-title">Partisipasi dalam Pameran dan Konferensi Teknologi</h2>
    <p class="article-text">Untuk tetap relevan dan kompetitif di industri teknologi yang selalu berkembang, TechSmart Electronics secara aktif berpartisipasi dalam berbagai pameran dan konferensi teknologi baik di dalam maupun luar negeri. Pameran ini termasuk acara-acara besar seperti Consumer Electronics Show (CES), Mobile World Congress (MWC), dan Indonesia International Electronics Show (IIES). Melalui partisipasi ini, kami dapat memamerkan produk-produk terbaru kami, memperkenalkan inovasi terbaru, dan berinteraksi langsung dengan pelanggan dan mitra bisnis.</p>
