...
<div class="article-content">
    <img src="/upload/aktivitas3.jpg" alt="TechSmart Image" class="article-image">
    <h2 class="article-title">Kegiatan CSR (Corporate Social Responsibility)</h2>
    <p class="article-text">Sebagai perusahaan yang peduli terhadap masyarakat dan lingkungan, TechSmart Electronics berkomitmen untuk menjalankan berbagai program Corporate Social Responsibility (CSR) yang bermanfaat. Kami percaya bahwa keberhasilan bisnis tidak hanya diukur dari keuntungan finansial tetapi juga dari dampak positif yang dapat diberikan kepada masyarakat sekitar. Salah satu program CSR unggulan kami adalah inisiatif "Tech for Education," di mana kami menyumbangkan perangkat elektronik seperti laptop, tablet, dan proyektor ke sekolah-sekolah yang kurang mampu di daerah terpencil.</p>
