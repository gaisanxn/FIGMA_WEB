...
<head>
    ...
    <style>
        ...
        .carousel-inner {
            ...
            width: 100%;
            height: 80vh;
            /* Tinggi slider 80% dari tinggi viewport */
            overflow: hidden;
        }
        ...
        .carousel-caption {
            ...
            /* Memusatkan teks */
            margin-top: 60px;
            /* Menambahkan margin atas untuk menggeser ke bawah */
            padding: 10px;
            /* Menambahkan padding untuk memberi ruang */
            box-sizing: border-box;
            /* Agar padding tidak mengubah ukuran elemen */
        }
        ...
        .carousel-caption h1 {
            ...
            margin: 0 0 10px 0;
            /* Menambahkan margin bawah untuk memberi jarak dengan elemen berikutnya */
        }

        .carousel-caption p {
            font-size: 0.8rem;
            font-family: 'Lexend Tera', sans-serif;
            /* Mengubah font menjadi Lexend Tera */
            background-color: transparent;
            /* Menghapus background */
            padding: 5px 10px;
            display: inline-block;
            margin: 0;
            /* Menghapus margin agar tidak ada spasi tambahan */
        ...
        @media (max-width: 375px) {
            ...
            .carousel-caption p {
                ...
                margin-top: 5px;
                /* Memberikan ruang antara h1 dan p */
            }
        ...
        .article-header {
            ...
            position: relative;
            /* Menambahkan konteks posisi */
            z-index: 10;
            /* Menentukan lapisan lebih tinggi */
        }
        ...
        @media (max-width: 1024px) {
            .contenttentang {
                flex-direction: column;
                /* Elemen berbaris vertikal */
                padding: 20px;
                /* Mengurangi padding untuk mengecilkan background */
                max-width: 800px;
                /* Membatasi lebar maksimal background */
                width: 90%;
                /* Menyesuaikan lebar agar tetap responsif */
                max-width: 850px;
                /* Menyesuaikan lebar container agar gambar tidak terlalu besar */
                align-items: center;
            ...
            .image-section {
                flex: none;
                /* Menonaktifkan flex agar ukuran lebih terkendali */
                width: 100%;
                /* Gambar tetap mengisi lebar penuh */
                max-width: 600px;
                /* Tetap membatasi lebar maksimum gambar */
                padding-right: 0;
            ...
            .text-section {
                flex: none;
                /* Menonaktifkan flex agar teks lebih terkendali */
                width: 100%;
                /* Teks memenuhi lebar container */
                padding-left: 0;
                /* Menghapus padding kiri */
                text-align: center;
                /* Menengahkan semua teks dalam .text-section */
            }
            ...
            .text-section p {
                ...
                margin-bottom: 20px;
                margin: 0 auto;
                /* Menengahkan blok teks */
                text-align: center;
                /* Menengahkan teks di dalam paragraf */
                display: inline-block;
                /* Membuat elemen mengikuti konten agar mudah ditengah-kan */
            }
        ...
        .product-card:hover {
            ...
            text-decoration: none;
            border-color: #000000;
            /* Ubah border menjadi hitam saat hover */
        }
        ...
        @media (min-width: 2560px) {
            .product-card {
                width: 20%;
                /* Menampilkan lebih banyak produk dalam satu baris */
            }
        }
        ...
        @media (max-width: 1440px) {
            .product-card {
                width: 25%;
                /* Menampilkan 4 produk dalam satu baris */
            }
        ...
        @media (max-width: 1024px) {
            .product-card {
                width: 33%;
                /* Menampilkan 3 produk dalam satu baris */
            }
        ...
        @media (max-width: 768px) {
            .product-card {
                width: 45%;
                /* Menampilkan 2 produk dalam satu baris */
            }
        ...
        @media (max-width: 425px) {
            .product-card {
                width: 90%;
                /* Menampilkan 1 produk dalam satu baris */
            }
        ...
        .card {
            position: relative;
            flex: 1 1 30%;
            /* Default untuk desktop, 3 kartu per baris */
            max-width: 330px;
            min-width: 250px;
            height: 300px;
            border-radius: 15px;
        ...
        @media (min-width: 2560px) {
            .card {
                flex: 1 1 20%;
                /* Menampilkan lebih banyak kartu per baris */
            }
        }
...
<?php
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    <span class="carousel-tagline"> <?= lang('Blog.header1'); ?> </span>
                    <h1><?= lang('Blog.namausaha'); ?></h1>
                    <p><?= lang('Blog.motto'); ?></p>
                </div>
            </div>
    ...
    <!-- Article Header -->
    <div class="article-header"><?= lang('Blog.slogantt'); ?></div>
    ...
    <div class="containertentang">
        <div class="contenttentang">
            ...
            <div class="text-section">
                ...
                <p>
                    <a href="<?= ($lang == 'en') ? base_url('/en/about') : base_url('/id/tentang') ?>" class="read-more-link"><?= lang('Blog.bacaselengkapnya'); ?> </a>
                </p>
            </div>
        </div>
    </div>
    ...
    <!-- Article Header 2 -->
    <div class="article-header2"> <?= lang('Blog.mottoproduk'); ?> </div>
        ...
        <?php foreach ($produk as $item): ?>
            <a href="<?= base_url(($lang === 'en' ? 'en/product' : 'id/produk') . '/' . ($lang === 'en' ? $item->slug_en : $item->slug)); ?>" class="product-card">
                ...
                <div class="product-info">
                    <h2> <?= esc($lang === 'id' ? $item->nama_produk : $item->nama_produk_en); ?>
                    </h2>
                    <div class="price">
    ...
    <!-- Article Header 3 -->
    <div class="article-header3"><?= lang('Blog.mottoaktivitas'); ?></div>
            ...
            <div class="card">
                ...
                <div class="overlay">
                    <div>
                        ...
                        <?php else: ?>
                            <h2><?= esc($item->judul_img_en); ?></h2>
                        <?php endif; ?>
                        <hr class="separator">
                        <p>
                            <a href="<?= base_url(($lang === 'en' ? 'en/activities' : 'id/aktivitas') . '/' . ($lang === 'en' ? $item->slug_en : $item->slug)); ?>"><?= lang('Blog.bacaselengkapnya'); ?></a>
                        </p>
                    </div>
                </div>
            </div>
