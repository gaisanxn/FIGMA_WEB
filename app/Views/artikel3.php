...
.article-image {
    ...
    height: auto; /* Tinggi gambar menyesuaikan dengan proporsi */
...
<div class="article-content">
    <img src="/upload/Artikel3.jpg" alt="TechSmart Image" class="article-image">
    <p class="article-date">08 JUNE 2024</p>
    <h2 class="article-title">Keamanan dan Privasi di Era Digital: Solusi dari TechSmart Electronics</h2>
    <p class="article-text">Di era digital yang penuh dengan konektivitas, keamanan dan privasi menjadi prioritas utama bagi konsumen dan bisnis. TechSmart Electronics memahami pentingnya aspek ini dan telah mengambil langkah-langkah konkret untuk menghadirkan solusi yang melindungi data dan privasi pengguna. Dengan perangkat yang dilengkapi fitur keamanan canggih dan kebijakan privasi yang ketat, perusahaan ini berusaha memberikan rasa aman bagi pelanggan di seluruh dunia. Salah satu inovasi terbaru dari TechSmart Electronics adalah pengembangan perangkat dengan sistem keamanan biometrik yang ditingkatkan, seperti pengenalan wajah dan sidik jari. Teknologi ini memastikan bahwa hanya pengguna yang berwenang yang dapat mengakses perangkat dan data pribadi mereka.</p>
</div>
