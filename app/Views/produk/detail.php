...
<head>
    ...
    <style>
        ...
        .page-title {
            ...
            /* Menggunakan League Spartan untuk Page Title */
            font-weight: 600;
            /* Menambahkan font weight untuk efek tebal */
            z-index: 2;
        ...
        .breadcrumb {
            ...
            font-size: 16px;
            font-family: 'League Spartan', sans-serif;
            /* Menggunakan League Spartan untuk Breadcrumb */
            font-weight: 400;
        ...
        .breadcrumb a {
            ...
            font-family: 'League Spartan', sans-serif;
            /* Menggunakan League Spartan untuk link Breadcrumb */
        }
        ...
        .article-image {
            ...
            display: block;
            /* Menjadikan gambar sebagai elemen blok */
            margin-left: auto;
        ...
        .article-title {
            ...
            margin: 8px;
            padding: 0 10px;
            /* Memberi jarak di kiri dan kanan */
        }
        ...
        .carousel-item img {
            width: 100%;
            /* Tetap mempertahankan lebar penuh gambar */
            height: 190px;
            /* Mengatur tinggi gambar slider */
            object-fit: cover;
            /* Membuat gambar tetap proporsional dan terpusat */
            position: relative;
        }
        ...
        .carousel-overlay {
            ...
            z-index: 1;
            /* Pastikan overlay berada di bawah teks */
        }

        .carousel-inner {
            position: relative;
            /* Posisi relatif untuk kontainer */
        }
        ...
        .techsmart-header-container {
            ...
            /* Vertical center */
            height: 100px;
            /* Sesuaikan tinggi kontainer sesuai kebutuhan */
            margin: 0 auto;
        }
    </style>
</head>
...
<body>
    ...
    <div class="article-content">
        ...
        <h2 class="article-title"><?= $produk->nama_produk ?></h2>
            <p class="article-text"><?= $produk->deskripsi_produk?>
            </p>
    </div>
