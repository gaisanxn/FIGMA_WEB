...
.article-content {
    width: 90%; /* Lebar default responsif */
    max-width: 648.78px; /* Batas maksimal untuk layar besar */
    background-color: #021526;
    padding: 0;
    margin: 40px auto;
    position: relative;
...
.article-image {
    width: 100%;
    height: auto; /* Sesuaikan tinggi agar lebih responsif */
    aspect-ratio: 16 / 9; /* Proporsi gambar agar tetap rapi di berbagai layar */
    object-fit: cover;
    display: block;
    margin: 0;
    border-top-right-radius: 70px;
...
/* Media Query untuk layar tablet dan ponsel besar (max-width: 768px) */
@media (max-width: 768px) {
    .article-content {
        width: 90%;
        margin: 20px auto;
...
/* Media Query untuk layar ponsel besar (max-width: 425px) */
...
/* Media Query untuk layar ponsel kecil (max-width: 375px) */
...
/* Media Query untuk layar sangat kecil (max-width: 320px) */
