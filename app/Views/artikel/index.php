...
.navbar-toggler {
    border: none; /* Menghilangkan border untuk membuat tampilan lebih bersih */
        ...
        .container-reverse {
            display: flex;
            align-items: center;
            /* Memastikan gambar dan konten berada di tengah */
            justify-content: center;
            /* Untuk konten dan gambar tetap di tengah secara horizontal */
            flex-direction: row;
            /* Default: gambar di kiri, konten di kanan */
            max-width: 980px;
            margin: 20px auto;
            padding: 20px;
            background-color: #E2E2B6;
        ...
        .image {
            width: 330px;
            height: 340px;
            /* Membuat gambar .image sedikit lebih tinggi */
        ...
        @media (max-width: 768px) {
            ...
            .container-reverse {
                flex-direction: column;
                /* Pada mobile, gambar berada di atas konten */
            }
        ...
        @media (max-width: 480px) {
            ...
            .image {
                width: 280px;
                height: 290px;
                /* Mengurangi ukuran untuk layar yang lebih kecil */
        ...
        @media (max-width: 320px) {
            ...
            .image {
                width: 240px;
                height: 250px;
                /* Menyesuaikan ukuran lagi untuk layar sangat kecil */
...
<?php
    ...
    ?>
                ...
                <a href="<?= base_url(($lang === 'en' ? 'en/article' : 'id/artikel') . '/' . ($lang === 'en' ? $artikelItem->slug_en : $artikelItem->slug)); ?>" class="read-more-link"><?=lang('Blog.bacaselengkapnya');?></a>
